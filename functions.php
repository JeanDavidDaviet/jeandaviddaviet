...
function add_theme_scripts() {
  ...
  wp_enqueue_style( 'style', get_template_directory_uri() . "/dist/css/main.css", [], filemtime(get_template_directory_uri() . "/dist/css/main.css"));
  // wp_enqueue_script( 'script', get_template_directory_uri() . "/dist/js/script.min.js", [], false, true);
}
